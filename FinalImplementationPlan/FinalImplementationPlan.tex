...
Armed with the information from the initial part of the research, the student and the stakeholders will agree on a suitable research focus for the remainder of the project, including a proof of concept focused on reducing latency.
\subsection{Client outline}
The stakeholders in this project are the student (Leon Koster), Saxion's XR Lab (Matthijs van Veen) and the \hyperref[sec:int]{Industrial Reality Hub}.
...
As I outlined earlier, the main focus for this report is on latency reduction and security. To compare solutions I will measure \acrfull{mtp} latency as the primary benchmark. These measurements will then be compared to a "traditional" local \acrshort{vr} setup's \acrshort{mtp} time. This will give insight about the effectiveness of a prototype and where the bottlenecks are.

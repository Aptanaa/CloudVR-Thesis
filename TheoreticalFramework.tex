...
After establishing the needed knowledge about the context, in this section all the individual components of a cloud \acrshort{vr} pipeline are being presented. Furthermore an overview of pre-made components will be presented and which part of the pipeline they address.

\begin{figure}[h]
\caption{Overview of components in a typical cloud \acrshort{vr} pipeline}
\label{fig:pipeline}
\includegraphics[scale=0.5]{CloudVR_PipelineComponents}
\end{figure}
